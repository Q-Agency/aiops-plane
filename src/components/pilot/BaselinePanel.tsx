 ...
 * badge (client-provided vs Q-default) and links to the Edit-assumptions
  ...
  return (
    <section className="glass-panel p-4 flex flex-col gap-2">
      ...
      <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        {baseline.source === "client-provided"
          ? " You provided this figure in FIRE UP → Go live → Targets & budget."
