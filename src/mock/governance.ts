...
export const violations: Violation[] = [
  ...
  { id: "v-004", ruleId: "be.types", rule: "Untyped `Any` in fraud_signals.score() with no justification",          severity: "medium",  cb: "backend", ticketId: "AM-140", agent: "sa",     artifact: "architecture.md §3",             status: "waived", note: "Score is open-schema until v2", detectedAt: now - 6*3600_000 },
